...
export default function App() {
  ...
  // FECHA GLOBAL (Controla Dashboard y Agenda)
  ...
  const addTransaction = async (t) => {
    try {
      ...
      setView('dashboard'); // Vuelve al Home al guardar
  ...
  return (
    <div className="min-h-screen font-sans text-gray-800 bg-[#f3f4f6]">
      ...
      <main className="max-w-5xl mx-auto p-4 mt-2 pb-10">
        ...
        {/* IMPORTANTE: Aquí pasamos 'services' para la Marea Semanal */}
