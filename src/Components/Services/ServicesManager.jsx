            ...
            <div className="flex justify-between items-center px-2">
                ...
                <div className="flex items-center gap-2">
                    <div className={`hidden sm:flex items-center rounded-xl p-1 ${isGlass ? 'bg-white/10' : 'bg-gray-100'}`}>
                        <button type="button" onClick={() => setViewMode('list')} className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${viewMode === 'list' ? (isGlass ? 'bg-indigo-600 text-white shadow-md' : 'bg-white text-gray-900 shadow-sm') : (isGlass ? 'text-white/50 hover:text-white' : 'text-gray-500 hover:text-gray-900')}`}>Lista</button>
                        <button type="button" onClick={() => setViewMode('calendar')} className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${viewMode === 'calendar' ? (isGlass ? 'bg-indigo-600 text-white shadow-md' : 'bg-white text-gray-900 shadow-sm') : (isGlass ? 'text-white/50 hover:text-white' : 'text-gray-500 hover:text-gray-900')}`}>Mes</button>
                    </div>
                    <button type="button" onClick={() => openModal()} className={`text-xs px-4 py-2 rounded-2xl font-bold shadow-md flex items-center gap-1 active:scale-95 transition-transform ${isGlass ? 'bg-white text-indigo-900 hover:bg-indigo-50' : 'bg-gray-900 text-white hover:bg-black'}`}><span>+</span> Nuevo Fijo</button>
                </div>
            </div>
            
            <div className={`sm:hidden flex items-center rounded-xl p-1 mx-2 ${isGlass ? 'bg-white/10' : 'bg-gray-100'}`}>
                <button type="button" onClick={() => setViewMode('list')} className={`flex-1 px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${viewMode === 'list' ? (isGlass ? 'bg-indigo-600 text-white shadow-md' : 'bg-white text-gray-900 shadow-sm') : (isGlass ? 'text-white/50 hover:text-white' : 'text-gray-500 hover:text-gray-900')}`}>Lista</button>
                <button type="button" onClick={() => setViewMode('calendar')} className={`flex-1 px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${viewMode === 'calendar' ? (isGlass ? 'bg-indigo-600 text-white shadow-md' : 'bg-white text-gray-900 shadow-sm') : (isGlass ? 'text-white/50 hover:text-white' : 'text-gray-500 hover:text-gray-900')}`}>Mes</button>
            </div>
