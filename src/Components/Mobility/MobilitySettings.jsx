                        ...
                        <div className="space-y-2">
                            {Object.keys(activePlatforms).map(key => (
                                <div key={key} className="flex items-center justify-between">
                                    ...
                                    >
                                        <div className={`w-11 h-6 rounded-full transition-colors relative ${activePlatforms[key] ? 'bg-violet-500' : 'bg-gray-300 dark:bg-white/20'}`}>
                    ...
                    <div>
                            ...
                            {expenseCategories.map(cat => (
                                <div key={cat.id} className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        >
                                            <div className={`w-9 h-5 rounded-full transition-colors relative ${cat.active ? 'bg-violet-500' : 'bg-gray-300 dark:bg-white/20'}`}>
                                        ...
                                        <button 
                                            ...
                                            className="min-h-[44px] min-w-[44px] flex items-center justify-center p-2.5 text-red-400 hover:bg-red-400/10 rounded-xl transition-colors"
                                        >
                                            <X size={16} />
                                        </button>
                                    </div>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button aria-label="Agregar categoría" type="button" 
                                onClick={addCategory}
                                className="min-h-[44px] min-w-[44px] p-2.5 rounded-xl bg-violet-500 text-white hover:bg-violet-600 transition-colors flex items-center justify-center shrink-0"
                            >
                                <Plus size={18} />
                            </button>
                        </div>
