...
export default function StopLossModal({ isOpen, onClose, asset, isGlass, currencyView = 'USD', rate }) {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            showToast(`Stop Loss de ${asset.especie} guardado`, 'success');
            onClose();
        } catch (error) {
            console.error('Error al guardar stop loss:', error);
            showToast('Error al guardar stop loss', 'error');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleConfirmDelete = async () => {
        ...
        try {
            ...
            showToast(`Stop Loss de ${asset.especie} eliminado`, 'success');
            setIsConfirmDeleteOpen(false);
            onClose();
        } catch (error) {
            console.error('Error al borrar stop loss:', error);
            showToast('Error al eliminar Stop Loss', 'error');
        } finally {
            setLoading(false);
        }
    };
