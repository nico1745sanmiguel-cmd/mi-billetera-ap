...
import { Scale, Wallet, Receipt, Users, LogOut, AlertCircle, BarChart3, Sun } from 'lucide-react';
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl overflow-hidden mx-1">
                ...
                {splitData ? (
                    ...
                    <div className="p-5 text-center">
                        <div className="flex justify-center mb-2"><Wallet size={32} className="text-yellow-400 drop-shadow" /></div>
