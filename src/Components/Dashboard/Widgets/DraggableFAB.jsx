        ...
        >
            <AnimatePresence>
                {menuOpen && (
                    ...
                    >
                        <button 
                            aria-label="Crear nueva nota rápida" 
                            type="button" 
                            onClick={handleNewNote} 
                            className="min-h-[44px] flex items-center gap-2 bg-yellow-300 text-yellow-900 px-4 py-2.5 rounded-full shadow-lg font-bold whitespace-nowrap active:scale-95 transition-transform border border-yellow-400"
                        >
                        ...
                        <button 
                            ...
                            className="min-h-[44px] flex items-center gap-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-4 py-2.5 rounded-full shadow-lg font-bold whitespace-nowrap active:scale-95 transition-transform border border-white/20"
                        >
            ...
            <button 
                aria-label={menuOpen ? "Cerrar menú de acciones rápidas" : "Abrir acciones rápidas"}
