  ...
  return (
    <div className="space-y-6 animate-fade-in pb-24">
      ...
      <div className="grid grid-cols-2 gap-4">
          <div onClick={() => setView('super')} className="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm flex flex-col justify-between h-32 cursor-pointer hover:border-purple-200 transition-colors group relative overflow-hidden">
