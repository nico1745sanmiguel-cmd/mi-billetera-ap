export const assetDescriptions = {
    ...
    'BYMA': 'Bolsas y Mercados Argentinos S.A. Entidad bursátil que integra los mercados y cámaras compensadoras de Argentina.',
    'NKE': 'Nike, Inc. (CEDEAR/Acción). Empresa multinacional estadounidense dedicada al diseño, desarrollo, fabricación y comercialización de calzado, ropa, equipo y accesorios deportivos.',
    'LOMA': 'Loma Negra C.I.A.S.A. Principal empresa fabricante de cemento en Argentina.',
    'TGSU2': 'Transportadora de Gas del Sur S.A. La empresa líder en el transporte de gas natural en Argentina y la más importante de América Latina.',
    'EDN': 'Empresa Distribuidora y Comercializadora Norte S.A. (Edenor). La mayor distribuidora de electricidad de Argentina.',
    'TRAN': 'Compañía de Transporte de Energía Eléctrica en Alta Tensión Transener S.A. Empresa operadora de la red nacional de transporte eléctrico de alta tensión en Argentina.',
    'MIRG': 'Mirgor S.A. Empresa argentina dedicada a la producción de componentes electrónicos, móviles e infoentretenimiento para la industria automotriz y de consumo.',
    'COME': 'Sociedad Comercial del Plata S.A. Holding argentino con operaciones en energía, telecomunicaciones, entretenimiento y agroindustria.',
    ...
    'PYPL': 'PayPal Holdings, Inc. (CEDEAR/Acción). Sistema de pagos en línea global.',
    'AMD': 'Advanced Micro Devices, Inc. (CEDEAR/Acción). Empresa de semiconductores estadounidense que desarrolla procesadores de computación y gráficos.',
    'INTC': 'Intel Corporation (CEDEAR/Acción). El mayor fabricante de circuitos integrados del mundo, según sus ingresos.',
    'NVDA': 'NVIDIA Corporation (CEDEAR/Acción). Empresa tecnológica multinacional, líder en el diseño de unidades de procesamiento gráfico (GPUs) para gaming y centros de datos de IA.',
    'META': 'Meta Platforms, Inc. (CEDEAR/Acción). Antiguamente Facebook, empresa matriz de redes sociales como Facebook, Instagram, y WhatsApp.',
    'NFLX': 'Netflix, Inc. (CEDEAR/Acción). Empresa de entretenimiento y plataforma de streaming estadounidense.',
    'DIA': 'SPDR Dow Jones Industrial Average ETF Trust (CEDEAR/ETF). Fondo cotizado que replica el índice Dow Jones, compuesto por 30 de las mayores corporaciones de EE. UU.',
    'IWM': 'iShares Russell 2000 ETF (CEDEAR/ETF). Fondo que replica el índice Russell 2000, centrado en empresas estadounidenses de pequeña capitalización.',
    'EEM': 'iShares MSCI Emerging Markets ETF (CEDEAR/ETF). ETF que invierte en acciones de empresas de mercados emergentes a nivel mundial.',
    'VOO': 'Vanguard S&P 500 ETF (CEDEAR/ETF). ETF gestionado por Vanguard que replica el rendimiento del S&P 500.',
    'XLE': 'Energy Select Sector SPDR Fund (CEDEAR/ETF). ETF que agrupa a las principales compañías del sector energético del S&P 500.',
    'XLF': 'Financial Select Sector SPDR Fund (CEDEAR/ETF). ETF que representa el sector financiero del S&P 500.',
    'BABA': 'Alibaba Group (CEDEAR/Acción). Consorcio privado chino que opera en el sector del comercio electrónico y servicios en la nube.',
    'WMT': 'Walmart Inc. (CEDEAR/Acción). Corporación multinacional estadounidense que opera cadenas de grandes almacenes de descuento y clubes de almacenes.',
    'JNJ': 'Johnson & Johnson (CEDEAR/Acción). Empresa estadounidense fabricante de dispositivos médicos, productos farmacéuticos, productos de cuidado personal, perfumes y para bebés.',
