 ...
 * Usa pdfjs-dist v5 instalado localmente (sin CDN externo).
...
export const extractTextFromPDF = async (file, password = null) => {
    try {
        // Importamos el paquete local (pdfjs-dist v5) en lugar del CDN
        const pdfjsLib = await import('pdfjs-dist');

        // En pdfjs-dist v5 con Vite, el worker se configura apuntando al archivo
        // que Vite sirve desde node_modules como asset estático.
        ...
        try {
            ...
            if (error.name === 'PasswordException') {
                // code 1 = se necesita contraseña, code 2 = contraseña incorrecta
        ...
        // Validación básica de palabras clave del resumen
